    ...
    extend: {
      ...
      colors: {
        ...
        upload: {
          ...
          "zone-border": "hsl(var(--upload-zone-border))",
          "zone-border-active": "hsl(var(--upload-zone-border-active))",
        },
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        ...
        "elevated": "0 4px 12px -2px rgba(0, 0, 0, 0.1), 0 8px 24px -4px rgba(0, 0, 0, 0.06)",
      },
    },
  },
